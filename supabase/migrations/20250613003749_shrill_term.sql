/*
  ...
  1. New Tables
    ...
    - `review_responses` - Professional responses to reviews
    - `review_helpful_votes` - Community voting on review helpfulness

  2. Security
    - Enable RLS on all new tables
    - Add policies for proper access control
    - Reviews visible to public, reviewees, and reviewers
    - Portfolio items managed by professionals

  3. Features
    - Detailed rating categories (skills, communication, timeliness, professionalism)
    - Portfolio with project details, media, and outcomes
    - Review response system for professional engagement
    - Helpful voting to surface quality reviews
    - Automatic rating calculations for professional profiles
*/
