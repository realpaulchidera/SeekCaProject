/*
  ...
  1. New Tables
    ...
    - `review_helpful_votes` - Helpful voting on reviews
  ...
  4. Performance
    ...
    - Optimized functions for data retrieval
*/
...
-- Now drop existing functions (after triggers are dropped)
...
-- Create functions (after dropping old ones)
