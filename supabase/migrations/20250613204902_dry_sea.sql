/*
  ...
  1. New Tables
    - `reviews` - Post-project feedback and ratings
  ...
  3. Functions
    ...
    - Portfolio and review retrieval functions
...
DROP FUNCTION IF EXISTS get_professional_portfolio(uuid, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS get_professional_reviews(uuid, integer, integer) CASCADE;
DROP FUNCTION IF EXISTS get_review_statistics(uuid) CASCADE;
DROP FUNCTION IF EXISTS update_reviews_updated_at() CASCADE;
DROP FUNCTION IF EXISTS update_portfolio_items_updated_at() CASCADE;
DROP FUNCTION IF EXISTS update_review_responses_updated_at() CASCADE;
