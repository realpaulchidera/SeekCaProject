/*
  ...
  1. New Tables
    - `reviews` - Store reviews and ratings between users
    - `portfolio_items` - Professional portfolio showcase items
  ...
  3. Features
    - Detailed rating system (overall + category ratings)
    - Portfolio showcase with project details
    - Review responses and helpful voting
