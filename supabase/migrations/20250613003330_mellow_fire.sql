/*
  ...
  1. New Tables
    - `reviews` - Post-project reviews with detailed ratings
    - `portfolio_items` - Professional work showcase
    - `review_responses` - Professional responses to reviews
    - `review_helpful_votes` - Community feedback on reviews

  2. Security
    - Enable RLS on all new tables
    - Add policies for proper access control
    - Ensure only project participants can review each other

  3. Functions
    - Update professional ratings automatically
    - Portfolio and review retrieval functions
    - Review statistics calculations

  4. Triggers
    - Auto-update ratings when reviews change
    - Update helpful counts on votes
